...
/**
 * @brief  Start PWM on given timer/channel with frequency, duty cycle, and pulse count
 * @param  htim        Pointer to timer handle (e.g., &htim3)
 * @param  channel     TIM_CHANNEL_X macro
...
/**
 * @brief  Stops PWM on a specified timer and channel.
 * @param  htim: Pointer to a TIM_HandleTypeDef structure that contains
 *               the configuration information for TIM module.
 * @param  channel: Specifies the TIM channel to stop.
...
/**
 * @brief  Callback invoked by HAL on input capture event
